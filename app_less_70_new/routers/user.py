...
from app_less_70_new.schemas import CreateUser, UpdateUser, UserResponse
from app_less_70_new.models import User, Task
...
@router.get("/user/{user_id}/tasks", response_model=TaskResponse)
